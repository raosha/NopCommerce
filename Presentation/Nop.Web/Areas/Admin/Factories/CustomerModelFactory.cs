...
namespace Nop.Web.Areas.Admin.Factories
{
    ...
    public partial class CustomerModelFactory : ICustomerModelFactory
    {
        ...
        /// </summary>
        /// <param name="searchModel">Customer search model</param>
        ///  /// <param name="onlyShowActiveCustomers">if need to get only active customers</param>
        /// <returns>Customer list model</returns>
        public virtual CustomerListModel PrepareCustomerListModel(CustomerSearchModel searchModel,bool onlyShowActiveCustomers = false)
        {
            if (searchModel == null)
                throw new ArgumentNullException(nameof(searchModel));
            ...
            var customers = _customerService.GetAllCustomers(customerRoleIds: searchModel.SelectedCustomerRoleIds.ToArray(),
                ...
                pageIndex: searchModel.Page - 1, pageSize: searchModel.PageSize,getOnlyActiveCustomers: onlyShowActiveCustomers);
