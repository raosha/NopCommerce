...
namespace Nop.Web.Areas.Admin.Controllers
{
    public partial class CustomerController : BaseAdminController
    {
        ...
        public virtual IActionResult CustomerList(CustomerSearchModel searchModel)
        {
            ...
            //prepare model
            var model = _customerModelFactory.PrepareCustomerListModel(searchModel,true); // D-Channel only Want Client as their users. They dont want to see ebay customers as their users. Hence excluding them from the list.
