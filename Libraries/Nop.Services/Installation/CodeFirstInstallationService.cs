        ...
        protected virtual void InstallTopics()
        {
            ...
            var topics = new List<Topic>
            {
                ...
                new Topic
                {
                    ...
                    Body =
                        "<p>iConnect unlocks your potential of ecommerece by maintaining your critical data at one centeralized location while seamlessly integrating to the popular ecommerece businesses and automating end to end process.</p>",
                    TopicTemplateId = defaultTopicTemplate.Id
                },
                new Topic
                {
